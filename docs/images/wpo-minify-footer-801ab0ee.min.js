...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/core.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/mouse.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/resizable.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/draggable.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/controlgroup.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/checkboxradio.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/button.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/dialog.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/ui/slider.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-includes/js/jquery/jquery.ui.touch-punch.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-content/plugins/mp3-jplayer/js/jquery.jplayer.min.2.7.1.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-content/plugins/mp3-jplayer/js/mp3-jplayer-2.7.js\n- Error message: "+ e.message);}
try{
...
try{
MP3J_pd={settings:{},plugin_url:'',init:function(){if(typeof MP3jPLAYERS!=='undefined'){MP3_JPLAYER.extCalls.init.push(MP3J_pd.setup_players)}},setup_players:function(){var j;var playlist;var i;var L;var lButton;for(j in MP3jPLAYERS){if(MP3J_pd.isPlaylister(j)){if(MP3jPLAYERS[j].download===!0){playlist=MP3jPLAYERS[j].list;L=playlist.length;if(MP3J_pd.settings.lButtons){for(i=0;i<L;i+=1){lButton=MP3J_pd.make_list_button_html(playlist[i].mp3,j,i);jQuery('#UL_mp3j_'+j+' li:nth-child('+(i+1)+')').prepend(lButton);if(MP3_JPLAYER.vars.force_dload===!0){MP3J_pd.add_list_listener(j,i)}}}
if(!MP3J_pd.settings.dButtons){jQuery(MP3_JPLAYER.eID.dload+j).remove()}}}}},make_list_button_html:function(url,j,i){var html='';html+='<div class="pd_listButtonWrap '+MP3J_pd.settings.lClass+'"><a href="'+url+'" id="linkDL_'+j+'_'+i+'" target="_blank">'+MP3J_pd.settings.lText+'</a></div>';return html},add_list_listener:function(j,i){jQuery('#linkDL_'+j+'_'+i).on('click',function(e){var p=MP3_JPLAYER.pl_info[j];MP3_JPLAYER.dl_runinfo(p.list[i].mp3,j,e);MP3_JPLAYER.runExternals('download',p.list[i]);e.preventDefault()})},isPlaylister:function(j){var p=MP3jPLAYERS[j]
return('MI'===p.type)?!0:!1}};

}
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-content/plugins/playlist-downloads/js/frontend.js\n- Error message: "+ e.message);}
try{
MJPsimplestats={showPlayCounts:0,showDownloadCounts:0,init:function(){var extCall=function(data){MJPstats_request(data,'change_post_MJPsimplestats')};MP3_JPLAYER.extCalls.change_post.push(extCall);var extCallD=function(data){MJPstats_request(data,'download_MJPsimplestats')};MP3_JPLAYER.extCalls.download.push(extCallD)},displayCounts:function(){var j;var playlist;var i;var L;var html;for(j in MP3jPLAYERS){playlist=MP3jPLAYERS[j].list;L=playlist.length;for(i=0;i<L;i+=1){html=MJPsimplestats.makeCountHtml(j,i);if(MJPsimplestats.isPlaylister(j)){jQuery('#mjp_ext_li_'+j+'_'+i).append('<div class="emjp_stats_counts">'+html+'</div>')}else if(MJPsimplestats.isSingle(j)){jQuery('#mp3jWrap_'+j).append('<span class="emjp_stats_counts">'+html+'</span>');break}}}},makeCountHtml:function(j,i){var track=MP3jPLAYERS[j].list[i];var plays=typeof track.play_total!=='undefined'?track.play_total:'0';var downloads=typeof track.download_total!=='undefined'?track.download_total:'0';var html='';if(MJPsimplestats.showPlayCounts){html+='<span class="emjp_stats_number">'+plays+'</span> Play'+(plays==1?'':'s')}
if(MJPsimplestats.showDownloadCounts){html+=html==''?'':', ';html+='<span class="emjp_stats_number">'+downloads+'</span> Download'+(downloads==1?'':'s')}
return html},isPlaylister:function(j){var p=MP3jPLAYERS[j]
return('MI'===p.type)?!0:!1},isSingle:function(j){var p=MP3jPLAYERS[j]
return('single'===p.type)?!0:!1}};function MJPstats_request(info,action,callback){var data={'action':action,'info':info,'tID':MP3_JPLAYER.tID};jQuery.ajax({type:"POST",data:data,url:statsMJPajax.WPajaxurl,success:function(response){if(typeof callback!=='undefined'){callback(response)}}})};jQuery(document).ready(function(){if(typeof MP3_JPLAYER!=='undefined'){MJPsimplestats.init()}});

}
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://asherhaimhalevi.ordisoftware.com/wp-content/plugins/simple-stats/js/frontend.js\n- Error message: "+ e.message);}
try{
